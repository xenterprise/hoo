 ...
 */
public class controlsB2 extends Fragment {
...
//Reading the States Before Rendering
        ...
        if(((HomeActivity)getActivity()).WashRoom2_2G_A_1.compareTo("OF1")==0) {
        ...
        btnControl1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(((HomeActivity)getActivity()).WashRoom2_2G_A_1.compareTo("OF1")==0) {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_2G_A, "ON1");
                    ((HomeActivity)getActivity()).WashRoom2_2G_A_1="ON1";
                    btnControl1.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_blue));
                }
                else {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_2G_A, "OF1");
                    ((HomeActivity)getActivity()).WashRoom2_2G_A_1="OF1";
                    btnControl1.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_red));
                }
            }
        });
        btnControl2 = view.findViewById(R.id.btn2g_2);
        if(((HomeActivity)getActivity()).WashRoom2_2G_A_2.compareTo("OF3")==0) {
        ...
        btnControl2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(((HomeActivity)getActivity()).WashRoom2_2G_A_2.compareTo("OF3")==0) {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_2G_A, "ON3");
                    ((HomeActivity)getActivity()).WashRoom2_2G_A_2="ON3";
                    btnControl2.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_blue));

                }
                else {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_2G_A, "OF3");
                    ((HomeActivity)getActivity()).WashRoom2_2G_A_2="OF3";
                    btnControl2.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_red));
                }
            }
        });
...
//1 G
        ...
        if(((HomeActivity)getActivity()).WashRoom2_1G_A_1.compareTo("OF2")==0) {
        ...
        btnBase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(((HomeActivity)getActivity()).WashRoom2_1G_A_1.compareTo("OF2")==0) {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_1G_A, "ON2");
                    ((HomeActivity)getActivity()).WashRoom2_1G_A_1="ON2";
                    btnBase.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_blue));
                }
                else {
                    ((HomeActivity) getActivity()).SwitchCore(((HomeActivity) getActivity()).WashRoom2_1G_A, "OF2");
                    ((HomeActivity)getActivity()).WashRoom2_1G_A_1="OF2";
                    btnBase.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.switchbutton_red));
